...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='平台预设API资源';
...
CREATE TABLE `p_menu` (
  ...
  UNIQUE KEY `uq_path` (`path`) USING BTREE,
  UNIQUE KEY `uq_name` (`name`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='平台预设资源表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='模块';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='产品';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='平台预设角色表';
...
CREATE TABLE `p_tenant` (
  ...
  `audit_status` smallint(3) DEFAULT NULL COMMENT '审核结论 (0-待审核同步，1-通过 , 2-驳回)',
  `audit_remark` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '审核意见',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='租户产品模块菜单关联表';
...
CREATE TABLE `sys_user` (
  ...
  `avatar` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '图像',
  `gender` smallint(3) DEFAULT NULL COMMENT '性别(0-女，1-男)',
  `status` smallint(3) DEFAULT NULL COMMENT '账号状态(0-正常，1-禁用)',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
